...
export default function BestLawyer({ lawyer }) {
    return (
      <div className="bg-transparent border border-white/10 p-4 flex flex-row gap-5 items-center hover:border-white/30 hover:scale-105 transition-all duration-300">
