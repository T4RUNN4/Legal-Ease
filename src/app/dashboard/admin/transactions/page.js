          ...
          <tbody className="divide-y divide-white/5 text-lg">
            {transactions.map((transaction) => (
              ...
              >
                ...
                <td className="py-4 px-6">{transaction.lawyerName}</td>
                <td className="py-4 px-6">${transaction.fee}</td>
                <td className="py-4 px-6"> {format(new Date(transaction.transaction.transactionDate), "PPPP")}</td>
              </tr>
            ))}
          </tbody>
        </table>
